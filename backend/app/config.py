...
class Settings(BaseSettings):
    ...
    # Nexum Router (Dialagram) -- OpenAI-compatible proxy for Qwen models.
    # Empty by default; the Qwen tile only appears in the picker when this is
    # populated, so the UI never advertises a model the server can't reach.
    nexum_api_key: str = ""
    nexum_base_url: str = "https://dialagram.me/router/v1"
