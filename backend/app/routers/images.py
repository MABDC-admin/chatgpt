...
async def generate_image(
    ...
    # Accept anything the imaging router knows how to serve. Without this,
    # the standalone /api/images endpoint silently swaps user-selected Qwen
    # requests down to the OpenAI default -- the same phantom-model bug that
    # motivated the picker rewrite. imaging.default_model() is the single
    # source of truth for "is this model reachable right now."
    model = imaging.default_model(payload.model)
