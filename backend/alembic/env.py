...
use exactly the same connection string as the running service.
"""
...
def _include_object(obj, name, type_, reflected, compare_to):
    """Skip the pgvector index: alembic cannot round-trip HNSW opclasses."""
    if type_ == "index" and name == "ix_chunk_embedding":
        return False
    return True
