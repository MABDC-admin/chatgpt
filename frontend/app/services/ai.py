...
_INTENT_PROMPT = """You route messages in a school assistant that can both chat and create images. Read the user's latest message and answer with exactly one word.
...
TEXT - anything else, including every question ABOUT images or about you.

Critical distinction. A question about your abilities is TEXT, not a request to draw. The user wants an answer, not a picture. These are all TEXT:
...
Rules:
- If the message is phrased as a question and does not give a subject to draw, choose TEXT.
